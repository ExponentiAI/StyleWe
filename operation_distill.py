...
def creat_folder(save_folder, trial_name):
    ...
    saved_model_folder = os.path.join(save_folder, 'Distill_results/%s/models' % name_time)
    saved_image_folder = os.path.join(save_folder, 'Distill_results/%s/images' % name_time)
    folders = [os.path.join(save_folder, 'Distill_results'), os.path.join(save_folder, 'train_results/%s' % name_time),
               os.path.join(save_folder, 'Distill_results/%s/images' % name_time),
               os.path.join(save_folder, 'Distill_results/%s/models' % name_time)]
